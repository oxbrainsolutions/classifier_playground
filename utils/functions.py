...
def create_gauge(num_value, label, key):
        ...
        "series": [
            ...
            "pointer": {
                "icon": 'path://M12.8,39.4l-12,-40.1H25.3L12.8,39.4z',
                "width": 15,
...
def svm_param_selector():
    ...
    st.markdown(text_media_query_functions1 + text, unsafe_allow_html=True)
    user_C = st.number_input(label="", label_visibility="collapsed", min_value=0.01, max_value=2.00, step=0.01, value=0.01, key="key_svm1", on_change=change_callback3)
