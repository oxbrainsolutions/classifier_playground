...
def plot_scatter(x_train, y_train, x_test, y_test):
    ...
    fig.update_layout(autosize=True, height=500, width = 500, margin=dict(l=5, r=10, b=40, t=10), legend=dict(font=dict(size=14, family="sans-serif", color="#FAFAFA"), bgcolor="rgba(0, 0, 0, 0)", orientation="h", yref="paper", yanchor="bottom", y=0, xref="paper", xanchor="right", x=1))
