...
def plot_scatter(x_train, y_train, x_test, y_test):
    ...
    fig.add_annotation(dict(font=dict(color="#FCBC24", size=16, family="sans-serif"), yref="paper", yanchor="top", y=0, xref="paper", xanchor="left", x=0.5, showarrow=False, text="X))
    return fig
