...
def plot_scatter(x_train, y_train, x_test, y_test):
    ...
    fig.add_annotation(dict(font=dict(color="#FAFAFA", size=16, family="sans-serif"), yref="paper", yanchor="top", y=-0.05, xref="paper", xanchor="left", x=0.5, showarrow=False, text="X1"))
    return fig
