...
def plot_scatter_decision_boundary(label, model, x_train, y_train, x_test, y_test):
    ...
    fig.add_annotation(dict(font=dict(color="#FAFAFA", size=20, family="sans-serif"), yref="paper", yanchor="top", y=0.95, xref="paper", xanchor="left", x=0.05, showarrow=False, text="{}".format(label)))
    return fig
