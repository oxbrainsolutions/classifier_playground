...
with col2:
  if st.session_state.submit_confirm1 == True:
    ...
    if st.session_state.submit_confirm2 == True:
        duration_text = '<p class="information_text" style="margin-top: -1em; margin-bottom: 0em; text-align: center;"><span style="font-family:sans-serif; color:#FAFAFA; font-size: 1em; ">Model training completed in {} seconds</span></p>'.format('{:,.3f}'.format(duration))
