...
import base64
import time
from utils.functions import generate_data, plot_scatter, plot_scatter_decision_boundary, create_gauge, convert_rating, add_polynomial_features, train_model, lr_param_selector, nb_param_selector, knn_param_selector, nn_param_selector, svm_param_selector, rf_param_selector
