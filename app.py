...
st.set_page_config(page_title="Classifier Playground", page_icon="images/oxbrain_favicon.png", layout="wide")
...
with col2:
  ...
  information_text1 = '''
    <p class="information_text" style="margin-top: 2em; margin-bottom: 0em; text-align: justify;"><span style="color: #FAFAFA; font-family: sans-serif; font-size: 1em; ">In this interactive playground, you can explore the capabilities of multiple AI and ML models for classifying data. To begin, create your own dataset using the options provided in the side menu. Once your dataset is ready, you can select a ML model to train and test on the data. The model will learn from the patterns and relationships within the dataset to make predictions and classify new instances. Investigate the various models, tweak the parameters and see how different algorithms perform on your dataset.</span></p>
  '''
...
<div class="content-container">
    <div class="footer">
        <div class="middle-column-footer">
            <b>DISCLAIMER: This playground may exhibit inherent limitations associated with the accuracy of predictions and is intended for educational purposes only.</b>
        </div>
        <div class="clear"></div>
    </div>
</div>
