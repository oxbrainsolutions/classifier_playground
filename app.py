                ...
                <div class="tooltip2">
                    ...
                    <span class="tooltiptext2">
                        <ul class="responsive-ul2">
                            The figure illustrates a decision boundary generated by your model. A decision boundary represents a dividing line that optimally separates the different classes of data based on the model and selected parameters. The goal of the model and the user is to find the best boundary that maximizes prediction accuracy.</br></br>
                            Accuracy and F1 score are common evaluation metrics used in classifier models to measure the performance of the model in predicting and classifying data.</br></br>   
