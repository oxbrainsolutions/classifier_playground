    ...
    with model_container:
      ...
      if st.session_state.user_model != "":
          ...
          if st.session_state.user_model == "Logistic Regression":
              ...
              info_text2 = '<p class="text" style="margin-top: 0em; margin-bottom: 0em;"><ul style="font-family:sans-serif; color:#FAFAFA; font-size: 0.8em; "><li>Regularization and complexity constraints: Logistic regression can use regularization techniques like L1 or L2 regularization to prevent overfitting and control model complexity.</li></ul></p>'
