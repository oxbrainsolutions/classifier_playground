...
with col1:
    if st.session_state.submit_confirm2 == True:
        if st.session_state.modal2.is_open():
            st.session_state.modal2.close()
        duration_text = '<p class="information_text" style="margin-top: -3em; margin-bottom: 1em; text-align: center;"><span style="font-family:sans-serif; color:#FAFAFA; font-size: 1em; ">Model training completed in {} seconds</span></p>'.format('{:,.3f}'.format(duration))
