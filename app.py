    ...
    with model_container:
      ...
      if st.session_state.user_model != "":
          ...
          if st.session_state.user_model == "Logistic Regression":
              ...
              st.markdown(text_media_query1 + info_text1, unsafe_allow_html=True)
              info_text2 = '<p class="text" style="margin-top: 0em; margin-bottom: 0em;"><ul><li style="font-family:sans-serif; color:#FAFAFA; font-size: 0.8em; text-align: justify;">Maximum depth and minimum sample split: Classification trees require the maximum depth or level of the tree and the minimum number of samples required to split an internal node the kernel function to be specified for model training.</li></ul></p>'
              st.markdown(text_media_query1 + info_text2, unsafe_allow_html=True)
