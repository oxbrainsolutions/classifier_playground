...
with st.sidebar:
  subheader_text = '''
  <p class="subheader_text" style="margin-top: -2.2em; margin-bottom: -3em; text-align: justify;"><span style="color: #FAFAFA; font-family: sans-serif; font-size: 1em; ">Create a Dataset</span></p>
  '''
