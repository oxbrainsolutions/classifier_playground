...
with col2:
  if st.session_state.submit_confirm1 == True:
    ...
    if st.session_state.submit_confirm2 == True:
        subheader_text3 = '<p class="subheader_text2" style="margin-top: 0em; margin-bottom: 0em; text-align: center;"><span style="font-family:sans-serif; color:#FAFAFA; font-size: 1.4em; ">{}</span></p>'.format(st.session_state.user_model)
