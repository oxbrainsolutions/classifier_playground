...
st.markdown("""
  <style>
    ...
    background-color: rgba(128, 77, 77, 1) !important;
    }
...
if modal.is_open():
    with modal.container():
        error_text1 = '''<p class="error_text1" style="margin-top: 3em; margin-bottom: 5em; text-align: justify;"><span style="color: rgba(128, 13, 13, 1); font-family: sans-serif; font-size: 1em; font-weight: bold;">Error</span></p>'''
        error_media_query1 = '''
        <style>
        @media (max-width: 1024px) {
            p.error_text1 {
